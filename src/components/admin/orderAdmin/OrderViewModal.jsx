          ...
          <div className="overflow-y-auto flex-1">
            {activeTab === 'details' ? (
              <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="text-sm font-medium">Thông tin đơn hàng</div>
                          <div className="mt-2 space-y-2 text-sm">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>{new Date(order.orderDate).toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric',
                                hour: '2-digit',
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="text-sm font-medium">Thông tin người bán</div>
                          <div className="mt-2 space-y-2 text-sm">
                            <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="text-sm font-medium">Thông tin vận chuyển</div>
                          <div className="mt-2 space-y-2 text-sm">
                            <div className="grid grid-cols-2 gap-2">
                ...
                <div className="mb-6">
                  <h4 className="text-lg font-medium mb-4">Thông tin thanh toán</h4>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <div className="text-sm text-gray-500 mb-1">Phương thức thanht toán</div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span>${order.subtotal || (order.items.reduce((sum, item) => sum + (parseFloat(item.price.replace('$', '')) * item.quantity), 0).toFixed(2))}</span>
                      </div>
                      <div className="flex justify-between">
