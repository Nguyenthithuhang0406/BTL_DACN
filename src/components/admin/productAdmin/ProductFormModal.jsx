...
const ProductFormModal = ({ isOpen, onClose, onSubmit, initialData, formType = 'add' }) => {
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <form onSubmit={handleSubmit} className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-semibold">{formType === 'add' ? 'Add Product' : 'Edit Product'}</h3>
          ...
          <div className="mt-6">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {formData.variations.map((variation, index) => (
                <div key={index} className="flex items-center px-3 py-1 bg-gray-100 rounded-full text-gray-700 text-sm">
                  {variation}
                  <button
                    type="button"
          ...
          <div className="mt-6">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {formData.tags.map((tag, index) => (
                <div key={index} className="flex items-center px-3 py-1 bg-blue-100 rounded-full text-blue-800 text-sm">
                  {tag}
                  <button 
                    type="button" 
