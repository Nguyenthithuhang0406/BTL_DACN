export const blogData = [
    {
      ...
      date: "18/11/2024",
      summary: "Thời trang mùa lạnh không nên chỉ giới hạn với những món đồ trơn màu. Khi bổ sung cho tủ đồ các item họa tiết, phong cách của chị em sẽ trở nên đa dạng và trẻ trung hơn.",
    ...
    },
    {
      ...
      author: "Nguyễn Anh Dũng",
      date: "18/11/2024",
      summary: "Thời trang tối giản nhận được sự yêu thích của nhiều chị em. Dù không quá cầu kỳ, các set đồ tối giản vẫn giúp người mặc tỏa sáng với sự tinh tế, sang trọng.",

      thumbnail: "https://cdn.i-scmp.com/sites/default/files/d8/images/canvas/2023/11/10/a47620f1-901b-41d2-8658-627669b77ff7_2a3e2496.jpg",
      category: "Phong Cách",
    ...
    },
    {
      ...
      author: "Nguyễn Anh Dũng",
      date: "18/11/2024",
      summary: "Phụ nữ Nhật Bản mặc đẹp nhưng họ không lên đồ quá cầu kỳ. Những món thời trang có kiểu dáng cơ bản, chuẩn một bên vững với thời gian chính là trọng tâm trong phong cách của phụ nữ Nhật.",
      thumbnail: "https://giadinh.mediacdn.vn/zoom/700_438/296230595582509056/2024/9/20/avatar1726802299302-17268023006441951783096.jpg",
      category: "Thời Trang",
    ...
    },
    {
      ...
      author: "Nguyễn Anh Dũng",
      date: "18/11/2024",
      summary: "Jisoo (BLACKPINK) có phong cách thời trang rất đa dạng. Sang mùa lạnh, cô thường chọn những items có gam màu ngọt ngào, trẻ trung.",
      thumbnail: "https://file.hstatic.net/1000328498/article/thum_b793effcfa914d0a8fd014bb3eaec591.jpg",
      category: "Phong Cách",
    ...
    },
    {
      ...
      author: "Nguyễn Anh Dũng",
      date: "18/11/2024",
      summary: "Áo thun dài tay và quần jeans là những món đồ cơ bản trong tủ đồ của mọi cô gái. Chúng có thể được phối hợp đa dạng để tạo nên những set đồ phù hợp với nhiều hoàn cảnh khác nhau.",
      thumbnail: "https://phunuvietnam.mediacdn.vn/zoom/320_200/179072216278405120/2024/11/15/thiet-ke-chua-co-ten-2024-11-15t165241144-17316698288152087254795.jpg",
      category: "Phong Cách",
    ...
    },
    {
      ...
      author: "Nguyễn Anh Dũng",
      date: "18/11/2024",
      summary: "Phong cách thời trang tối giản đang ngày càng được yêu thích. Để mặc đẹp theo phong cách này, bạn cần nắm vững một số nguyên tắc cơ bản.",
      thumbnail: "https://file.hstatic.net/1000328498/article/thum_b793effcfa914d0a8fd014bb3eaec591.jpg",
      category: "Thời Trang",
...
export const blogContent = {
  ...
  "5-mon-thoi-trang-toi-gian-duoc-phu-nu-phap-dien-mai-khong-chan": [
    ...
    {
      type: "image",
      value: "https://file.hstatic.net/1000328498/article/thum_b793effcfa914d0a8fd014bb3eaec591.jpg"
    },
    {
      type: "text",
