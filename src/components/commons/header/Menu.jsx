    ...
    <>
      <div className="menu-desktop">
        <ul className="menu-desktop__list">
          ...
          <li className="menu-desktop__item">
            <span className="menu-desktop__item-span">Tin tức</span>
          </li>
          <li className="menu-desktop__item">
            <span className="menu-desktop__item-span">Liên hệ</span>
          </li>
          <li className="menu-desktop__item">
            <span className="menu-desktop__item-span">Hệ thống cửa hàng</span>
          </li>
          <li className="menu-desktop__item">
            <span className="menu-desktop__item-span">Kiểm tra đơn hàng</span>
          </li>
        </ul>
      </div>
